...
// basePage.sendKeyToElement(driver, "//input[@id='LastName']", "FC");
// basePage.sendKeyToElement(driver, "//input[@id='Email']", emailAddress);
// basePage.sendKeyToElement(driver, "//input[@id='Password']", "11111");
// basePage.sendKeyToElement(driver, "//input[@id='ConfirmPassword']", "11111");
//
// basePage.waitForElementClickable(driver, "//button[@id='register-button']");
// basePage.clickToElement(driver, "//button[@id='register-button']");
//
...
// basePage.sendKeyToElement(driver, "//input[@id='Email']", emailAddress);
// basePage.sendKeyToElement(driver, "//input[@id='Password']", "111111");
// basePage.sendKeyToElement(driver, "//input[@id='ConfirmPassword']", "111112");
//
// basePage.waitForElementClickable(driver, "//button[@id='register-button']");
// basePage.clickToElement(driver, "//button[@id='register-button']");
//
