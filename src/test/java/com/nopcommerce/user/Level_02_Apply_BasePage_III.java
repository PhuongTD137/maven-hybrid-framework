...
public class Level_02_Apply_BasePage_III extends BasePage {
	...
	public void TC_05_Register_Password_Less_Than_6_Chars() {
		...
		sendKeyToElement(driver, "//input[@id='LastName']", "FC");
		sendKeyToElement(driver, "//input[@id='Email']", emailAddress);
		sendKeyToElement(driver, "//input[@id='Password']", "11111");
		sendKeyToElement(driver, "//input[@id='ConfirmPassword']", "11111");
	...
	public void TC_06_Register_Invalid_Confirmed_Password() {
		...
		sendKeyToElement(driver, "//input[@id='Email']", emailAddress);
		sendKeyToElement(driver, "//input[@id='Password']", "111111");
		sendKeyToElement(driver, "//input[@id='ConfirmPassword']", "111112");
