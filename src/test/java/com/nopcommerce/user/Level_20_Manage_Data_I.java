...
public class Level_20_Manage_Data_I extends BaseTest {
	...
	private String firstName, lastName, emailAddress, password, company, day, month, year, gender;
	...
	public void beforeClass(String browserName) {
		...
		company = dataHelper.getCompanyName();
		day = "11";
		month = "May";
		year = "1996";
		gender = "Female";
	...
	public void User_01_Register() {
		...
		log.info("Register - Step 09: Select Birth day dropdown with value is'" + day + "'");
		userRegisterPage.selectDropdownByName(driver, "DateOfBirthDay", day);
